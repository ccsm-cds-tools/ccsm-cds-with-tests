Instance: CotestingScreeningRecommendation
InstanceOf: http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-computableactivity
Title: "USPSTF Cervical Cancer Screening Recommendations: Cotesting (cytology + HPV)"
Usage: #definition
// -----------------------------------------------------------------------------
// This ActivityDefinition generates a ServiceRequest that either contains an 
// immediate request for a cervical cytology + HPV test or the date for when the 
// next screening test is recommended to occur.
// -----------------------------------------------------------------------------
* insert CPGKnowledgeExtensions
* insert CommonMetadata
* meta.profile[+] = "http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-computableactivity"
// * cpg-partOf = Canonical(TopLevelPlanDefinition) // TODO: Tie this into the entire pathway
* url = "http://OUR-PLACEHOLDER-URL.com/ActivityDefintion/CotestingScreeningRecommendation"
* name = "CotestingScreeningRecommendation"
* title = "USPSTF Cervical Cancer Screening Recommendations: Cotesting (cytology + HPV)"
