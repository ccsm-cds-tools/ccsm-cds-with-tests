export const CervicalCancerScreeningDesExposure = {
  "resourceType": "PlanDefinition",
  "id": "CervicalCancerScreeningDesExposure",
  "meta": {
    "profile": [
  ...
  "library": [
    "http://OUR-PLACEHOLDER-URL.com/Library/ScreeningDesExposureLibrary|1.0.0"
  ],
  "action": [
    {
      ...
      "condition": [
        {
          ...
          "expression": {
            ...
            "reference": "Library/ScreeningDesExposureLibrary|1.0"
          }
        }
      ],
      "action": [
        ...
        },
        {
          ...
          "description": "Make screening recommendations for individuals exposed to DES",
          "textEquivalent": "Static text equivalent of the action, used if the dynamic aspects cannot be interpreted by the receiving system",
          "condition": [
            {
              "kind": "applicability",
