export const ManageCervicalRareAbnormalities = {
  "resourceType": "PlanDefinition",
  "id": "ManageCervicalRareAbnormalities",
  "meta": {
    "profile": [
  ...
  "action": [
    ...
    {
      "title": "Exceptions to Colposcopy Clinical Action Threshold",
      "description": "Brief description of the action",
      "textEquivalent": "Static text equivalent of the action, used if the dynamic aspects cannot be interpreted by the receiving system",
      "documentation": [
        {
      ...
      "condition": [
        {
          ...
          "expression": {
            "language": "text/cql",
            "expression": "ColposcopyException",
            "reference": "Library/ManagementLibrary|1.0"
          }
        }
      ],
    ...
    {
      "title": "Managing Histology Results",
      "description": "Brief description of the action",
      "textEquivalent": "Static text equivalent of the action, used if the dynamic aspects cannot be interpreted by the receiving system",
      "documentation": [
        {
    ...
    {
      "title": "Surveillance after abnormalities",
      "description": "Brief description of the action",
      "textEquivalent": "Static text equivalent of the action, used if the dynamic aspects cannot be interpreted by the receiving system",
      "documentation": [
        {
      ...
      "condition": [
        {
          ...
          "expression": {
            "language": "text/cql",
            "expression": "SurveillanceAfterAbnormalities",
            "reference": "Library/ManagementLibrary|1.0"
          }
        }
      ],
      ...
      "condition": [
        {
          ...
          "expression": {
            "language": "text/cql",
            "expression": "SpecialPopulation",
            "reference": "Library/ManagementLibrary|1.0"
          }
        }
      ],
      "definitionCanonical": "http://OUR-PLACEHOLDER-URL.com/PlanDefinition/ManageCervicalSpecialPopulations|1.0.0"
    }
  ]
}
