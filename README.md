...
Before the CQL can be tested, it must first be converted to the computer-interpretable ELM JSON representation. This is only necessary if the CQL source is modified and can be accomplished using the [CQL-to-ELM Translator Reference Implementation](https://github.com/cqframework/clinical_quality_language/blob/master/Src/java/cql-to-elm/OVERVIEW.md).
